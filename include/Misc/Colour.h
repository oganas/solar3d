...
static constexpr glm::vec4 DARK_GRAY = glm::vec4(0.2f, 0.2f, 0.2f, 1.0f);
static constexpr glm::vec4 LIGHT_GRAY = glm::vec4(0.8f, 0.8f, 0.8f, 1.0f);

static constexpr glm::vec4 ORANGE = glm::vec4(1.0f, 0.65f, 0.0f, 1.0f);
